...
///
/// Note: This only receives the sockets. The caller must call `request_shutdown_old_instance`
/// after the new instance is fully started and ready to accept connections.
