...
pub struct RedisClusterTopologyRewriteConfig {
    pub new_port: u16,
}

#[async_trait]
impl TransformsFromConfig for RedisClusterTopologyRewriteConfig {
    async fn get_source(&self, _topics: &TopicHolder) -> Result<Transforms> {
        Ok(Transforms::RedisClusterTopologyRewrite(
            RedisClusterTopologyRewrite {
...
#[derive(Clone)]
pub struct RedisClusterTopologyRewrite {
    new_port: u16,
}
