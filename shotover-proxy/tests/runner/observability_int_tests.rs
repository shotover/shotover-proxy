...
# TYPE shotover_connections_accept_failures_count counter
# TYPE shotover_listener_create_failures_count counter
...
shotover_connections_accept_failures_count{source="valkey"}
shotover_listener_create_failures_count{source="valkey"}
