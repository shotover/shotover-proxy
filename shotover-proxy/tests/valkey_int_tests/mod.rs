...
Caused by:
    0: Chain valkey failed to send and/or receive messages, the connection will now be closed.
    1: valkey-sink transform failed in chain valkey
...
Caused by:
    0: valkey-sink transform failed in chain valkey
