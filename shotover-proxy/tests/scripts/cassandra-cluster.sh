...
function defer {
	docker-compose -f $SCRIPT_DIR/../../tests/test-configs/cassandra-cluster/docker-compose.yaml down
}

trap defer EXIT

docker-compose -f $SCRIPT_DIR/../../tests/test-configs/cassandra-cluster/docker-compose.yaml up
