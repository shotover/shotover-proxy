...
function defer {
	docker-compose -f $SCRIPT_DIR/../../examples/cassandra-cluster/docker-compose.yml down
}

trap defer EXIT

docker-compose -f $SCRIPT_DIR/../../examples/cassandra-cluster/docker-compose.yml up