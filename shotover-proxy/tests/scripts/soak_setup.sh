...
/usr/bin/time -v -o $SCRIPT_DIR/../../tests/soaktest-`date +%s` $SCRIPT_DIR/../../target/release/shotover-proxy --config-file $SCRIPT_DIR/../../config/config.yaml --topology-file $SCRIPT_DIR/../../examples/redis-cluster/topology.yaml
