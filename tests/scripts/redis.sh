...
function defer {
	docker-compose -f $SCRIPT_DIR/../../examples/redis-passthrough/docker-compose.yml down
}

trap defer EXIT

docker-compose -f $SCRIPT_DIR/../../examples/redis-passthrough/docker-compose.yml up
